    ...
    <form action={handleSubmit} className="mt-8 space-y-6">
      ...
      <div className="flex items-center justify-between mt-2">
         ...
         <div className="text-sm">
           <Link href="/auth/login" className="font-bold text-[#0F6FFF] hover:text-gray-900 transition-colors">
             Sign in
           </Link>
         </div>
      </div>
      ...
      <button
        type="submit"
        disabled={loading}
        className="group relative flex w-full justify-center items-center rounded-xl border-2 border-gray-900 bg-[#FF8A21] px-4 py-3 text-sm font-black text-white shadow-[4px_4px_0px_0px_rgba(17,24,39,1)] transition-all hover:bg-orange-500 hover:shadow-[2px_2px_0px_0px_rgba(17,24,39,1)] hover:translate-x-[2px] hover:translate-y-[2px] disabled:opacity-70 disabled:cursor-not-allowed"
      >
        {loading ? (
